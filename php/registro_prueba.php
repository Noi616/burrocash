...
// Insertar datos en la base de datos
$stmt = mysqli_prepare($conexion, "INSERT INTO usuario (nombre, correo, contraseña, apellido_paterno, apellido_materno, numero_telefono, foto_perfil) VALUES (?, ?, ?, ?, ?, ?, ?)");
mysqli_stmt_bind_param($stmt, 'sssssss', $nombre, $email, $contrasenaCifrada, $APaterno, $AMaterno, $telefono, $fotoPerfilDefault);
